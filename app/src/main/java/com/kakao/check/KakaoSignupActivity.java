...
import static com.kakao.usermgmt.StringSet.propertyKeys;
...
public class KakaoSignupActivity extends Activity{
    ...
    private void redirectMainActivity(UserProfile userProfile) {
        ...
        intent.putExtra("id", userProfile.getEmail());
        intent.putExtra("nickname", userProfile.getNickname());
        intent.putExtra("profile", userProfile.getThumbnailImagePath());
